...
export default function TermsAndConditionsPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-center mb-4 text-[#5D4432]">Terms & Conditions</h1>
      ...
      <div className="space-y-6">
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <li>Products must be unused, unworn, undamaged, and returned in original packaging with invoice.</li>
                ...
                <li>An amount of Rs. 250 will be deducted from the total amount as handling charges.</li>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              <h3 className="font-semibold mb-2">To the maximum extent permitted by law (Under Indian Law), PINJJAI BY H is not liable to you or anyone else for:</h3>
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>Any decision, action or inaction taken in reliance on information in, or connected with, this site.</li>
                <li>Any losses, costs or damages suffered or incurred by you, including (without limitation) direct or indirect, special, incidental, compensatory, exemplary or consequential damages in connection with this website.</li>
                <li>Your use or misuse of this website or any information or material contained in this website.</li>
                <li>The loss or modification of information or material transmitted from this website.</li>
                <li>Any defect, technical problem or virus attached to or arising from this website or server.</li>
                <li>Any injury, illness or allergic reaction you or any other person may sustain due to yarn, fabric, hardware, or usage of any of the products bought through this website.</li>
                <li>The products displayed being unavailable at any time.</li>
                <li>Your inability to access or use the website or any material on the website.</li>
                <li>The loss of confidentiality in any information or material transmitted to or from the website.</li>
              </ul>
            </div>
