    ...
    <div className='w-full py-16 px-4 md:px-8 lg:px-16 bg-(--brand-white)'>
      <div className='max-w-7xl mx-auto'>
        <div className='text-center mb-12'>
          <h2 className='text-3xl md:text-4xl lg:text-5xl font-bold text-(--brand-dark) mb-4 font-serif'>Featured Products</h2>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8'>
          {featuredProducts.map((product: any) => (
            <StoreProductCard key={product._id.toString()} product={{ ...product, _id: product._id.toString() }} />
          ))}
        </div>
